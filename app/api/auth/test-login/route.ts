...
export async function POST() {
  ...
  await authStore.set(id, { didVerified: true, countryCode: "KR", walletAddress: "0x0000000000000000000000000000000000000001", walletVerification: "siwe", didExpiresAt: expiresAt, walletExpiresAt: expiresAt });
