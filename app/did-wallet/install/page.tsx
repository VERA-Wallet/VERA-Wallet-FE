  ...
  return (
    <main className="space-y-6 px-5 py-8">
      ...
      <ol className="list-decimal space-y-4 pl-5 text-sm leading-6">
        <li>Android 휴대전화에서 설치 파일을 열고, 필요한 경우 해당 브라우저의 ‘이 출처 허용’을 켜서 설치합니다.</li>
      ...
      <p className="rounded-xl bg-white p-4 text-sm leading-6 text-zinc-600">이 페이지의 새 앱은 공개 HTTPS 연결을 사용합니다. QR은 노트북 등 다른 화면에 띄워 주세요. 같은 휴대전화에서 웹의 QR을 앱으로 바로 넘기는 기능은 아직 제공하지 않습니다.</p>
    </main>
  );
}
